...
<body>
        <nav class="navbar navbar-expand-lg navbar navbar-dark bg-dark">
            ...
            <a class="navbar-brand mt-2 mb-2" href="../home"><h2>AH Quadra!</h2></a>
            ...
            <div class="full-height form-inline mr-5">
                @if (Route::has('login'))
                    @auth
                        <a class="text-light" href="{{ route('login') }}">Entrar</a>
                    @else
        ...
        <div class="container-fluid mt-3 text-center">
            ...
            <div class="form-inline mt-1">
                <div class="col-3"> </div>
                <div class="col-6">
                    <h4><a class="btn btn-primary pt-2" href="../reservas"><h5>Click Pesquisar Quadras de Esportes</h5></a>
                </div>
                <div class="col-3"> </div>
            </div>        
        </div>
